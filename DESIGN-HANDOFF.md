# 14af5cde-141a-4dcf-bd10-1b3dfa9ed291 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `uploads/index.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `uploads/index.html`
...
- A single self-contained `uploads/index.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `uploads/index.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `images/mp5krbgm-Dinamize-automation.svg`
- `images/mp5krbgm-Dinamize-Logo.svg`
- `images/mp5krbgm-Dinamize-Simbolo.svg`
- `images/mp5qeves-image.png`
- `images/mp5tycqx-image.png`
- `images/mp5u8chk-image.png`
- `images/mp5ugs04-image.png`
- `images/mp5uqpbg-image.png`
- `images/mp5v0ou2-image.png`
- `images/mp5v61gc-image.png`
- `images/mp5vskk7-image.png`

## Coding checklist for AI tools
1. Inspect `uploads/index.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
